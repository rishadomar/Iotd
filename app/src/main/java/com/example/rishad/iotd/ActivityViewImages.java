...
import com.example.rishad.iotd.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class ActivityViewImages extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_view_images);
        ...
        findViewById(R.id.bNext).setOnTouchListener(mDelayHideTouchListener);
        loadTodaysImage();
    }
